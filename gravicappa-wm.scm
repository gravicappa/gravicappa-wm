...
(define-hook *internal-startup-hook*) ; (lambda (display))
(define-hook *internal-loop-hook*) ; (lambda (display))
(define-hook *shutdown-hook*) ; (lambda (display))
(define-hook *manage-hook*) ; (lambda (display window window-attrib screen))
(define-hook *unmanage-hook*) ; (lambda (display client))
(define-hook *arrange-hook*) ; (lambda (display screen))
(define-hook *focus-hook*) ; (lambda (display client))
(define-hook *keypress-hook*) ; (lambda (display keysym state))
(define-hook *retag-hook*) ; (lambda ())
(define-hook *rules-hook*) ; (lambda (client))
